        ...
        <div className="bg-white/[0.07] backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-slate-400 mt-1 text-center">
              {step === 1 ? 'Enter your email to receive an OTP' : 'Enter your 6-digit OTP and new password'}
            </p>
          </div>
          ...
          {success && (
            <div className="mb-5 px-4 py-3 rounded-lg bg-green-500/10 border border-green-500/20 text-green-300 text-sm">
              {success}
            </div>
          )}
            ...
            <form onSubmit={handleResetPassword} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-sm text-white bg-white/[0.06] border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-400/50 placeholder-slate-500 transition-all tracking-widest text-center"
                  placeholder="------"
                  maxLength={6}
                  required
                />
