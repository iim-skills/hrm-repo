...
export default function ComplianceDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'at-risk' | 'sandwich' | 'wfh' | 'alerts'>('at-risk');
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (tab === 'at-risk' || tab === 'sandwich' || tab === 'wfh' || tab === 'alerts') {
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="border-b border-slate-200 flex flex-wrap gap-0">
        <button
          ...
          className={`px-5 py-3 text-sm font-semibold border-b-2 transition-all duration-150 flex items-center gap-2 cursor-pointer ${
            activeTab === 'at-risk'
        ...
        >
          ...
          <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${
            activeTab === 'at-risk' ? 'bg-indigo-100 text-indigo-600' : 'bg-slate-100 text-slate-500'
          }`}>{atRiskCount}</span>
        </button>
        <button
        ...
        >
          ...
          <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${
            activeTab === 'sandwich' ? 'bg-indigo-100 text-indigo-600' : 'bg-slate-100 text-slate-500'
        ...
        >
          ...
          WFH Restrictions
          <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${
            activeTab === 'wfh' ? 'bg-indigo-100 text-indigo-600' : 'bg-slate-100 text-slate-500'
        ...
        >
          ...
          System Alerts
          <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${
            activeTab === 'alerts' ? 'bg-indigo-100 text-indigo-600' : 'bg-slate-100 text-slate-500'
          }`}>{totalAlerts}</span>
        </button>
                    ...
                    {atRiskEmployees.map((emp) => {
                      ...
                      return (
                        <tr key={emp._id} className="hover:bg-slate-50/70 transition-colors duration-150">
                          ...
                          {/* LWP Count */}
                          <td className="px-5 py-4">
                            <span className={`inline-flex items-center px-3 py-1 rounded-md text-[11px] font-bold border ${
                              emp.lwpCount > 3
                            ...
                            <td className="px-5 py-4 text-right">
                              <div className="inline-flex items-center gap-2 justify-end">
                                ...
                                <button
                                  ...
                                  className={`inline-flex items-center justify-center w-9 h-9 border rounded-xl transition-all duration-200 cursor-pointer flex-shrink-0 ${
                                    isExpanded
                                      ...
                                      <tbody className="divide-y divide-slate-100">
                                        {group.flags.map((flag) => (
                                          <tr key={flag._id} className="hover:bg-slate-50/30 transition-colors">
                                            ...
                                            <td className="px-6 py-3.5">
                                              <span className={`inline-flex px-2.5 py-1 rounded-lg text-[10px] font-extrabold uppercase tracking-wide border ${
                                                flag.isOverridden
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5 ${
                        isSandwich ? 'bg-rose-50' : isHalfDay ? 'bg-indigo-50' : 'bg-amber-50'
                      }`}>
                        {isSandwich ? (
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-2 flex gap-2 flex-wrap">
                          <span className={`inline-flex px-2.5 py-0.5 rounded-md text-[10px] font-bold border ${
                            isSandwich ? 'bg-rose-50 border-rose-200 text-rose-600'
